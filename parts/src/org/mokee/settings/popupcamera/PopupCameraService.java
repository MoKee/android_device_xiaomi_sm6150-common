...
public class PopupCameraService extends Service {
    ...
    private void registerReceiver() {
        ...
        filter.addAction("mokee.intent.action.CAMERA_STATUS_CHANGED");
        filter.addAction("mokee.intent.action.ACTIVE_PACKAGE_CHANGED");
    ...
    private BroadcastReceiver mIntentReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (mokee.content.Intent.ACTION_CAMERA_STATUS_CHANGED.equals(action)) {
                mCameraState = intent.getExtras().getString(mokee.content.Intent.EXTRA_CAMERA_STATE);
